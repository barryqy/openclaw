...
export OPENCLAW_REPO_REF="${OPENCLAW_REPO_REF:-24c95b45b3e8b662f7139efa4eb7232bc15a88cd}"
...
export DEFENSECLAW_REF="${DEFENSECLAW_REF:-e86b34d579a40a9e78653af1c0d68c55cf40a0ed}"
...
if [ "${BASH_SOURCE[0]}" = "$0" ]; then
  ...
  echo "DEFENSECLAW_REF=${DEFENSECLAW_REF}"
fi

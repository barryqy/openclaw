...
tmpDefenseClawRepo="${DEFENSECLAW_TEMP_REPO:-https://github.com/cisco-ai-defense/defenseclaw-temp.git}"
case "${tmpDefenseClawRepo}" in
  https://github.com/barryqy/defenseclaw-temp.git|git@github.com:barryqy/defenseclaw-temp.git)
    tmpDefenseClawRepo="https://github.com/cisco-ai-defense/defenseclaw-temp.git"
    ;;
esac

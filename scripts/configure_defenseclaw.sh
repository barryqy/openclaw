...
if not model_name and entry_model_name:
    model_name = entry_model_name
if not upstream_model and entry_upstream_model:
...
if litellm_cfg:
    ...
    print("LiteLLM config not present; using the built-in Go guardrail proxy path.")
